...
public class GenerationTypeTable implements CommandLineRunner {

	@Autowired
	private EmployeeService employeeService;
	
	public static void main(String[] args) {
		SpringApplication.run(GenerationTypeTable.class, args);
	}
	...
	{
		Employee employee = new Employee("riya","sharma","riya123@gmail.com",new Date());
